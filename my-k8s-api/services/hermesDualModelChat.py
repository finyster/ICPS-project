...
# ------------------------------------------------------------------
SYSTEM_PREFIX = (
    "You are a function calling AI model. Use the available tools below.\n"
    "Tools: <tools>" + TOOLS_JSON_TEXT + "</tools>\n"
    "When you need to use a tool, output one JSON object enclosed in <tool_call></tool_call>.\n"
    "Use markdown form to answer your question\n"
    "Schema: {\"name\": <function-name>, \"arguments\": <dict>}\n"
